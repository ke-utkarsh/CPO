...
import ymsli.com.cpo.data.model.TripMeterImagesModel
...
class TripImagesAdapter(private val context: Context, private val mList: ArrayList<TripMeterImagesModel>, nft:Boolean,
                        private var deleteImageListener: (( pPosition : ArrayList<Int>) -> Unit)) : RecyclerView.Adapter<TripImagesAdapter.ViewHolder>() {
