...
import ymsli.com.cpo.databinding.FullColorToastBinding
import ymsli.com.cpo.databinding.MotionToastBinding
...
class MotionToast {
    companion object {
        ...
        const val LONG_DURATION = 8000L // 5 seconds
        ...
        fun createColorToast(
            ...
            when (style) {
                ...
                MotionToastStyle.SUCCESS -> {
                    ...
                    binding.colorToastText.text = if (title.isNullOrBlank()) "" else title
